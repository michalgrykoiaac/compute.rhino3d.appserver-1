...
const definition = 'skyglazer final.gh'
var panelTypeVal = 1;
...
arcRadius1Output.innerHTML = arcRadius1.value;
...
arcRadius2Output.innerHTML = arcRadius2.value;
...
arcRadius3Output.innerHTML = arcRadius3.value;
...
arcRadius4Output.innerHTML = arcRadius4.value;
 ...
 function collectResults(responseJson) {
  ...
  //let colourVal = 111
    ...
    for ( let i = 0; i < values.length; i ++ ) {
     ...
     document.getElementById('panelTypevalue').innerText =  panelType 
     document.getElementById('colorGradientvalue').innerText =   colourGradient
     ...
     document.getElementById('groupTypevalue').innerText =  groupingType
